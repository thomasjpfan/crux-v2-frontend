    ...
    return (
      <Segment>
        <Form size="large" error={formErrorMessage !== ""}>
          <Form.Input
            label="Title"
            placeholder="Crux's Next Top Analysis"
          ...
          <Button primary type="button" onClick={this.openConfirmation}>
            Create Analysis
          </Button>
          <Message
            error
              ...
              <Modal.Actions>
                ...
                >
                  {createAnalysisOnCrux => (
                    <Button
                      primary
                      onClick={this.updateCruxWithAnalysis(
                        createAnalysisOnCrux
                      )}
...
export default withRouter(
  connect(mapStateToProps)(CreateAnalysisNotOnFigshareForm)
);
