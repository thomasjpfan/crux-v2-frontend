...
class CreateAnalysisFromFigshareForm extends Component {
  ...
  render() {
    const { description, tags, confirmCreateModalOpen, taskID, name, errorMessage, createAnalysisModalOpen, errorFormLabel } = this.state
    ...
    return (
      <Form error={errorMessage !== ""}>
        ...
        <Modal
          trigger={<Button primary type='button' onClick={this.validateForm}>Create Analysis</Button>}
          ...
          <Modal.Actions>
            ...
            >
              {(createSingleAnalysisFromFigshare) => {
                return (<Button color='green' onClick={(e) => this.createAnalysis(e, createSingleAnalysisFromFigshare)}>
