...
let FIGSHARE_AUTH_URL = `https://figshare.com/account/applications/authorize?client_id=${FIGHSARE_CLIENT_ID}&response_type=token`

export { GRAPHQL_URI, FIGSHARE_AUTH_STORAGE_KEY, CRUX_AUTH_STORAGE_KEY, CRUX_USERNAME_STORAGE_KEY, CRUX_UID_STORAGE_KEY, FIGSHARE_AUTH_STATE_STORAGE_KEY, FIGSHARE_AUTH_URL }
